...
def insert_one(p: int, q: int) -> None:
    """
    Create state_predictor_partial_complexity-wise_{p}_{q}.pt by copying from the closest
    ...
    dst_path = os.path.join(weights_dir, f"state_predictor_partial_complexity-wise_{p}_{q}.pt")
